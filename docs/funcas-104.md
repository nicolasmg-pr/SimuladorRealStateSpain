...
| 5 | The **INE household projection** is available as a scenario path, replacing the flat 240k/yr assumption. *(The chapter's 215k → 190k → 140k path is the 2022–2037 vintage; since 2026-09-08 it is one of three vintages in `scenario.INE_HOUSEHOLD_PROJECTIONS`, and the default is INE's 17 Jun 2026 projection, 205k → 139k → 93k — docs/kb-refresh-2026-09.md §2.)* | `scenario.HouseholdFormation`, `scenario.ine_household_projection`, CLI `ine-demography` | ch.1 §3 gráfico 7 |
